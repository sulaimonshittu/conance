    ...
    return (
        <div className="flex flex-col gap-s3 px-s3 py-s4 bg-white">
            ...
            <button
                ...
                className="flex items-center gap-s3 bg-primary p-s3 rounded-[24px] text-white text-left hover:bg-primary2 transition-all active:scale-[0.98] shadow-lg shadow-primary/20 group">
